...
async def test_claim_agent_service_run_claims_agent():
    ...
    with patch.object(svc, 'get_registry_assessor_agent') as mock_agent1:
        with patch.object(svc, 'get_registry_processor_agent') as mock_agent2:
